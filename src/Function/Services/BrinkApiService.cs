...
namespace Occtoo.Formatter.Brink.Services
{
    ...
    public class BrinkApiService : IBrinkApiService
    {
        ...
        public async Task<bool> PutPrice(OcctooPriceModel price)
        {
            ...
            try
            {
                var url = $"https://managment.eu-west-1.sptech.brinkcommerce.io/store-groups/001/product-variants/{price.Id}/prices";
                await SetToken();
        ...
        public async Task<bool> PutStock(OcctooStockModel stock)
        {
            ...
            try
            {
                var url = $"https://managment.eu-west-1.sptech.brinkcommerce.io/stock/product-variants/{stock.Id}/inventories/{stock.Id}";
                await SetToken();
