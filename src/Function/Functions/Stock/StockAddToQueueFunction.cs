...
{
    public class StockAddToQueueFunction
    {
        private readonly IOcctooApiService<OcctooStockModel> _occtooApiService;
        private readonly AppSettings _appSettings;

        public StockAddToQueueFunction(IOcctooApiService<OcctooStockModel> occtooApiService, AppSettings appSettings)
        {
        ...
        /// </summary>
        /// <returns></returns>
        [FunctionName(nameof(StockAddToQueueFunction))]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequest req,
            [Queue("%stockQueue%"), StorageAccount("AzureWebJobsStorage")] ICollector<string> que,
            ILogger log)
        {
